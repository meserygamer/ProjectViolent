...
{
    public class RegAuthDataUCViewModel : INotifyPropertyChanged
    {
        ...
        public RelayCommand ButtonCommand
        {
            get => _buttonCommand ?? (new RelayCommand(obj =>
            {
                ...
                else if (ConfirmPasswordHash != PasswordHash)
                {
                    MessageBox.Show("Введенные пароли не одинаковы");
                }
                else if (RegAuthDataUCModel.IsLoginFree(Login))
                {
